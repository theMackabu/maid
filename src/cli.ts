...
export function printHelp(): void {
  console.log(`Maid local task runner for Ant
...
Options:
  ...
  -g, --system <cmd>      System command: check-updates, upgrade, json, json-hydrated
...
function parseSystem(value: string): CliOptions["system"] {
  if (value === "check-updates" || value === "upgrade" || value === "json" || value === "json-hydrated") return value;
